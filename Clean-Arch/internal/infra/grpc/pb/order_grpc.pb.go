...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderResponse, error) {
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*ListOrderResponse, error) {
